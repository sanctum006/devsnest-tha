...
?q=somth smth => beech mein & normally likhne se it takes as dusra query, so we use uri encoder aise dono likhne ke liye normally inspect -> encodeURIcomponent("somthg&smth") -> jo string aae usko use karlo